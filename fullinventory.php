...
$qry = "SELECT * FROM parts ORDER BY " . $sortby;

$result = $mysqli->query($qry);


if ($result->num_rows > 0) {
    echo "<table>\n<tr><th><a href='fullinventory.php?sort=category'>CATEGORY</a></th><th><a href='fullinventory.php?sort=manufacturer'>ITEM</a></th><th><a href='fullinventory.php?sort=stock'>STOCK</a></th><th><a href='fullinventory.php?sort=reserved'>RESERVED</a></th><th><a href='fullinventory.php?sort=ordered'>ORDERED</a></th><th></th></tr>\n";
